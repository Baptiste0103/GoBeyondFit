...
/**
 * Mapper le niveau de difficulté à un type d'exercice
 * Tous les exercices sont de type 'standard' - EMOM et AMRAP sont des formats d'entraînement, pas des types d'exercices
 */
function mapDifficulty(difficulty: string | undefined): 'standard' | 'EMOM' | 'AMRAP' | 'custom' {
  // All exercises are 'standard' type. EMOM and AMRAP are workout formats, not exercise types
  return 'standard';
}
