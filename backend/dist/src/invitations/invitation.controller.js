...
let InvitationController = class InvitationController {
    ...
    async deleteInvitation(invitationId, req) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Send invitation to join a group' }),
    ...
    __metadata("design:paramtypes", [invitation_dto_1.SendInvitationDto, Object]),
    __metadata("design:returntype", Promise)
], InvitationController.prototype, "sendInvitation", null);
__decorate([
    (0, common_1.Get)('received'),
    (0, swagger_1.ApiOperation)({ summary: 'Get invitations received by current user' }),
    (0, swagger_1.ApiResponse)({
        status: common_1.HttpStatus.OK,
        description: 'List of received invitations',
        type: [invitation_dto_1.InvitationWithDetailsDto],
    }),
    ...
    __metadata("design:returntype", Promise)
], InvitationController.prototype, "getReceivedInvitations", null);
__decorate([
    (0, common_1.Get)('sent'),
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard),
    (0, roles_guard_1.Roles)(roles_guard_1.UserRole.COACH, roles_guard_1.UserRole.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: 'Get invitations sent by current coach' }),
    (0, swagger_1.ApiResponse)({
        status: common_1.HttpStatus.OK,
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], InvitationController.prototype, "getSentInvitations", null);
__decorate([
    (0, common_1.Post)(':id/accept'),
    (0, swagger_1.ApiOperation)({ summary: 'Accept an invitation' }),
    (0, swagger_1.ApiResponse)({
        status: common_1.HttpStatus.OK,
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Reject an invitation' }),
    (0, swagger_1.ApiResponse)({
        status: common_1.HttpStatus.OK,
